    ...
    <dl class="leftmenu">
        <dd>
            ...
            <ul class="menuson">
                ...
                <li class="active"><cite></cite><a href="/admin/summary_graphServlet">实习信息统计图</a><i></i></li>
                                ...
                                },
                                {
                                    ...
                                    markLine : {
                                        ...
                                        data : [
                                            <c:if test="${not empty registrationList}">
                                                <c:forEach items="${registrationList}" var="registration">
                                                    [{name:'${registration.getCity()}'}, {name:'南昌',value:${registration.getCount()}}],
                                                </c:forEach>
                                            </c:if>
